...
export const Header = (props) => {
  ...
  return (
    <header
      className={`fixed-top app-header ${
        isScrolled ? "header-background" : ""
      } pt-5 pb-3`}
    >
      <div className="d-flex align-items-center">
        ...
        <DropdownNav setClicked={setClicked} clicked={clicked} />
      </div>
      {clicked ? (
        <aside className="navbar-list mt-4 d-block">
          <ul className="list-group dropdown-list-group">
            <li className="list-group-item list-dropdown-item p-3">About</li>
            <li className="list-group-item list-dropdown-item p-3">Discover</li>
            <li className="list-group-item list-dropdown-item p-3">
              Get Started
            </li>
          </ul>
        </aside>
